            ...
            <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                ...
                <div class="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                        ...
                        <a href="/" aria-label="" class="hover:underline text-[#3A75F5] inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800">Learn more</a>
                    </div>
                    <div class="flex flex-col justify-between p-5 border rounded shadow-sm bg-white"
                        data-aos="fade-up"
                        data-aos-offset="200"
